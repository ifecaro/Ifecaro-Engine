...
mod benchmark_tests {
    ...
    fn benchmark_chapter_filtering() {
        ...
        assert!(
            ...
            "Chapter filtering took too long: {:?}",
            duration
        );
    }
    ...
    fn benchmark_paragraph_lookup() {
        ...
        assert!(
            duration < Duration::from_millis(100),
            "Paragraph lookup took too long: {:?}",
            duration
        );
    }
    ...
    fn benchmark_language_content_retrieval() {
        ...
        println!(
            "Language content retrieval (500 paragraphs × 3 languages) took: {:?}",
            duration
        );
        ...
        assert!(
            duration < Duration::from_millis(100),
            "Language content retrieval took too long: {:?}",
            duration
        );
    }
    ...
    fn benchmark_choice_processing() {
        ...
        println!(
            "Choice processing ({} choices) took: {:?}",
            total_choices, duration
        );

        // Should complete within 200ms
        assert!(
            duration < Duration::from_millis(200),
            "Choice processing took too long: {:?}",
            duration
        );
    }
    ...
    fn benchmark_concurrent_operations() {
        ...
        println!(
            "Concurrent operations ({} operations) took: {:?}",
    ...
    fn benchmark_memory_usage() {
        ...
        println!(
            "Accessing data from 10 datasets took: {:?}",
            access_duration
        );
        ...
        assert!(
            ...
            "Creating multiple datasets took too long: {:?}",
            duration
        );
        assert!(
            access_duration < Duration::from_millis(10),
            "Accessing multiple datasets took too long: {:?}",
            access_duration
        );
    }
...
mod stress_tests {
    ...
    fn stress_test_massive_dataset() {
        ...
        assert!(
            ...
            "Massive dataset creation took too long: {:?}",
            creation_duration
        );
        assert!(
            operation_duration < Duration::from_secs(1),
            "Operations on massive dataset took too long: {:?}",
            operation_duration
        );
    }
    ...
    fn stress_test_rapid_language_switching() {
        let (_current_language, _chapter_state, paragraph_state) =
            benchmark_tests::create_large_scale_test_data();
        ...
        println!(
            "Rapid language switching (10000 switches) took: {:?}",
            duration
        );
        ...
        assert!(
            ...
            "Rapid language switching took too long: {:?}",
            duration
        );
    }
    ...
    fn stress_test_concurrent_form_operations() {
        ...
        for i in 0..10000 {
            ...
            // Form validation
            let _is_valid = choices.iter().all(
                |(_text, targets, _type, _key, _value, _chapter, _same_page, _time_limit)| {
                    !targets.is_empty()
                },
            );
            operations += 1;
        ...
        println!(
            "Concurrent form operations ({} operations) took: {:?}",
            operations, duration
        );
        ...
        assert!(
            ...
            "Concurrent form operations took too long: {:?}",
            duration
        );
    }
}
