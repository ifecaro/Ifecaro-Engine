...
mod reader_mode_tests {
    ...
    fn test_reader_mode_single_paragraph() {
        let paragraphs = vec![create_test_paragraph(
            "single",
            "chapter1",
            "en",
            "Only one paragraph.",
    ...
    fn test_reader_mode_language_filtering() {
        ...
        let missing_result = merge_paragraphs_for_lang(&paragraphs, "fr", true, false, &[]);
    ...
    fn test_auto_expansion_random_path_wasm() {
        ...
        for _ in 0..iterations {
            ...
            let a1 =
                create_test_paragraph_with_choices("a1", "chapter1", "en", "A1", vec![], vec![]);
            let a2 =
                create_test_paragraph_with_choices("a2", "chapter1", "en", "A2", vec![], vec![]);
            let b1 =
                create_test_paragraph_with_choices("b1", "chapter1", "en", "B1", vec![], vec![]);
            let b2 =
                create_test_paragraph_with_choices("b2", "chapter1", "en", "B2", vec![], vec![]);
            let paragraphs = vec![
                start.clone(),
                a1.clone(),
                a2.clone(),
    ...
    fn test_complex_choice_structure() {
        ...
        assert_eq!(
            paragraph.choices[1].to,
            vec!["right_path_a", "right_path_b"]
        );
    ...
    fn test_story_path_expansion_logic() {
        ...
        let result = merge_paragraphs_for_lang(&expanded_path, "en", true, false, &[]);
