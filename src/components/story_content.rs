...
pub fn StoryContent(props: StoryContentProps) -> Element {
    ...
    rsx! {
        div {
            ...
            article {
                class: "prose-sm dark:prose-invert lg:prose-base mx-auto max-w-3xl p-8 text-gray-900 dark:text-white paper:text-[#2f2417] paper:prose paper:prose-base paper:bg-[#fef8e7] paper:shadow-sm bg-white dark:bg-transparent",
                div {
                    class: "whitespace-pre-wrap space-y-8",
